    ...
    try {
        ...
        const reviewPromises = bookingDetails.map(async(chiTiet) => {
            ...
            const reviewApiData = {
                ...
                sosao: sosao,
                danhgia: danhgia,
                // Navigation properties với dữ liệu đầy đủ
                makhNavigation: {
                    makh: makhachhang,
                    hoten: customerFullData ? (customerFullData.hoten || customerFullData.Hoten) : 'Unknown',
                    matkhau: customerFullData ? (customerFullData.matkhau || customerFullData.Matkhau || 'temp_password') : 'temp_password',
                ...
                maphongNavigation: {
                    maphong: maphong,
                    sophong: roomFullData ? (roomFullData.sophong || roomFullData.Sophong) : 'Unknown',
                    maloaiphong: roomFullData ? (roomFullData.maloaiphong || roomFullData.Maloaiphong) : null
                }
            };
