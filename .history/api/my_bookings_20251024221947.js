        ...
        const reviewPromises = bookingDetails.map(async(chiTiet) => {
            ...
            const reviewApiData = {
                ...
                makhNavigation: {
                    makh: makhachhang,
                    hoten: customerName,
                    matkhau: "review_system", // Sử dụng placeholder cho matkhau vì đây là yêu cầu của API
                ...
                maphongNavigation: {
                    maphong: maphong,
                    sophong: roomFullData ? (roomFullData.sophong || roomFullData.Sophong) : `P${maphong}`,
