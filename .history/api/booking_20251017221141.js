...
async function saveBooking(bookingData) {
    ...
    // Ensure total is a finite number and provide a normalized value to send to backend
    const tongTienFloat = parseFloat(tongTien) || 0;
        ...
        const datPhongPayload = {
            ...
            Trangthai: "Đã đặt",
            // Send both casing variants to be tolerant with backend property naming
