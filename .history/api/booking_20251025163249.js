...
async function saveBooking(bookingData) {
    try {
        ...
        const datPhongPayload = {
            ...
            Trangthai: "Đã hủy", // "Đã đặt" hoặc "Đã hủy" tùy tình huống
            // Tongtien, Dongia, Giamgia sẽ được trigger tự động cập nhật
            Trangthaithanhtoan: "Chưa thanh toán", // Sẽ cập nhật sau khi thanh toán VNPay thành công
        ...
        for (const maPhong in roomsGrouped) {
            ...
            const chiTietPayload = {
                ...
                madatphongNavigation: {
                    ...
                    Trangthaithanhtoan: "Chưa thanh toán", // Sẽ cập nhật sau khi thanh toán VNPay
