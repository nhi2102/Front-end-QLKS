...
function setupEventListeners() {
    ...
    validateDates();
    if (selectedRooms && selectedRooms.length) calculatePricing();
};
if (checkOutDate) checkOutDate.addEventListener('change', () => { validateDates(); if (selectedRooms && selectedRooms.length) calculatePricing(); });
