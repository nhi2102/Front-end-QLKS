...
async function showServiceHistory(bookingId) {
    ...
    if (body) body.innerHTML = `<tr><td colspan="5">Lỗi khi tải lịch sử dịch vụ: ${err.message || err}</td></tr>`;
    ...
    if (!Array.isArray(data) || data.length === 0) {
        if (body) body.innerHTML = '<tr><td colspan="5">Chưa có dịch vụ nào</td></tr>';
        const noHistory = document.getElementById('noHistoryData');
