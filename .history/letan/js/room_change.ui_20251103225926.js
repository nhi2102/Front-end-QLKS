    ...
    rooms.forEach(r => {
        ...
        `;
                ...
                <div class="price-discount">
                    <span class="old-price">${formatCurrency(giaCoBan)}</span>
                    <span class="new-price">${formatCurrency(giaKhuyenMai)}</span>
                    <span class="price-unit">/ đêm</span>
                </div>
                ${tenVoucher ? `<div class="voucher-badge"><i class="fas fa-tag"></i> ${tenVoucher}</div>` : ''}
            `;
        }
