...
// Expose cached data from api module (if present) to global for compatibility
Object.defineProperty(window, 'currentGuestsData', {
    get() {
        return (window.currentGuestsData !== undefined) ? window.currentGuestsData : (window.api && window.api._currentGuests ? window.api._currentGuests : undefined);
    },
    configurable: true
});