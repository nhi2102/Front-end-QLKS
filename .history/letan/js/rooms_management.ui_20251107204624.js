...
async function updateRoomStatus() {
    ...
    try {
        ...
        if (errorMessage.includes('Không tìm thấy phòng')) {
            ...
            errorMessage = 'Trạng thái mới trùng với trạng thái hiện tại!';
        } else if (errorMessage.includes('đang có khách ở')) {
            errorMessage = 'Phòng đang có khách ở, không thể chuyển sang bảo trì!';
        } else if (errorMessage.includes('bảo trì sang trạng thái đang dọn dẹp')) {
            errorMessage = 'Không thể chuyển phòng bảo trì sang trạng thái đang dọn dẹp!';
        }
