...
async function showCancelModal(madatphong, booking) {
    try {
        ...
        // 2. Tạo modal HTML
        const modalHTML = `
            <div class="cancel-modal-overlay" id="cancelModal" style="
                position: fixed; top: 0; left: 0; width: 100%; height: 100%; 
                background: rgba(0,0,0,0.7); z-index: 10000; display: flex; 
                align-items: center; justify-content: center; opacity: 0; 
                transition: opacity 0.3s ease;
            ">
                <div class="cancel-modal" style="
                ...
                ">
                    <div class="cancel-modal-header" style="
                        padding: 20px; border-bottom: 1px solid #e5e7eb; display: flex; 
                        justify-content: space-between; align-items: center;
                    ">
                        <h2 style="margin: 0; color: #1f2937; font-size: 18px;">
                            🚫 Xác Nhận Hủy Đặt Phòng
                        </h2>
                        <button class="cancel-modal-close" onclick="closeCancelModal()" style="
                    ...
                    <div class="cancel-modal-body" style="padding: 20px;">
                        <div class="cancel-booking-info" style="
                        ...
                        <div class="cancel-policy-box" style="
                            border: 1px solid #e5e7eb; border-radius: 8px; padding: 15px; margin-bottom: 20px;
                        ">
                            <h3 style="margin-top: 0; color: #374151;">
                                <i class="fas fa-info-circle" style="color: #3b82f6;"></i> Chính sách hủy
                            </h3>
                            <p style="color: #6b7280; margin-bottom: 15px;">${data.chinhSachHuy}</p>
                            
                            <div class="refund-details" style="margin-bottom: 15px;">
                                <div style="display: flex; align-items: center; margin-bottom: 8px; color: ${data.phanTramHoan === 100 ? '#059669' : '#6b7280'};">
                                    <i class="fas fa-clock" style="margin-right: 8px;"></i>
                                    <span>Hủy trước 48h: <strong>Hoàn 100%</strong></span>
                                    ${data.phanTramHoan === 100 ? '<i class="fas fa-check-circle" style="margin-left: 8px; color: #059669;"></i>' : ''}
                                </div>
                                <div style="display: flex; align-items: center; margin-bottom: 8px; color: ${data.phanTramHoan === 50 ? '#f59e0b' : '#6b7280'};">
                                    <i class="fas fa-clock" style="margin-right: 8px;"></i>
                                    <span>Hủy trước 24h: <strong>Hoàn 50%</strong></span>
                                    ${data.phanTramHoan === 50 ? '<i class="fas fa-check-circle" style="margin-left: 8px; color: #f59e0b;"></i>' : ''}
                                </div>
                                <div style="display: flex; align-items: center; color: ${data.phanTramHoan === 0 ? '#dc2626' : '#6b7280'};">
                                    <i class="fas fa-ban" style="margin-right: 8px;"></i>
                                    <span>Hủy trong 24h: <strong>Không hoàn tiền</strong></span>
                                    ${data.phanTramHoan === 0 ? '<i class="fas fa-check-circle" style="margin-left: 8px; color: #dc2626;"></i>' : ''}
                                </div>
                            </div>
                            
                            <div class="refund-summary" style="
                                background: ${data.phanTramHoan > 0 ? '#ecfdf5' : '#fef2f2'}; 
                                padding: 12px; border-radius: 6px; text-align: center;
                            ">
                                <div class="refund-amount">
                                    <span>Số tiền được hoàn:</span>
                                    <strong style="color: ${data.phanTramHoan > 0 ? '#059669' : '#dc2626'}; font-size: 18px;">
                        ...
                        <div class="cancel-reason" style="margin-bottom: 20px;">
                            <h3 style="margin-top: 0; color: #374151;">
                                <i class="fas fa-comment-dots" style="color: #8b5cf6;"></i> Lý do hủy phòng
                            </h3>
                            ...
                            <textarea id="cancelNote" placeholder="Ghi chú thêm (tùy chọn)..." rows="3" style="
                                width: 100%; padding: 10px; border: 1px solid #d1d5db; 
                        ...
                        ${data.phanTramHoan === 0 ? `
                        <div class="cancel-warning" style="
                    ...
                    <div class="cancel-modal-footer" style="
                        padding: 20px; border-top: 1px solid #e5e7eb; 
                        display: flex; gap: 10px; justify-content: flex-end;
                    ">
                        <button class="cancel-modal-btn btn-back" onclick="closeCancelModal()" style="
                            padding: 10px 20px; border: 1px solid #d1d5db; background: #fff; 
                            color: #374151; border-radius: 6px; cursor: pointer;
                        ">
                            <i class="fas fa-arrow-left"></i> Quay Lại
                        </button>
                        <button class="cancel-modal-btn btn-confirm-cancel" onclick="executeBookingCancel(${madatphong})" style="
