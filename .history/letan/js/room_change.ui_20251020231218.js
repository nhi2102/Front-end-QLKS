...
document.addEventListener('DOMContentLoaded', async() => {
    ...
    if (confirmBtn) {
        confirmBtn.addEventListener("click", async() => {
            try {
                const payload = {
                    maDatPhong: currentBooking.id, // hoặc currentBooking.maDatPhong
                    maPhongCu: currentBooking.currentRoomId,
                    maPhongMoi: selectedNewRoom.maphong,
                    lyDo: document.getElementById("changeReason").value,
                    nguoiThucHien: document.getElementById("userName").textContent
                };
        ...
        console.warn("⚠️ Không tìm thấy nút #confirmChangeBtn trong DOM!");
    }
...
function initializeEventListeners() {
    ...
    if (searchBtn) {
        ...
        console.warn("⚠️ Không tìm thấy #searchBookingBtn");
    }
    ...
    if (searchInput) {
        ...
        console.warn("⚠️ Không tìm thấy #searchValue");
    }
    ...
    if (cancelBtn) {
        ...
        console.warn("⚠️ Không tìm thấy #cancelChangeBtn");
    }
}
