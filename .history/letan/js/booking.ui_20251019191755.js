...
function displayAvailableRooms(rooms) {
    const isSelected = selectedRooms.some(r => (r.maphong || r.maPhong) == roomId);
    const selectBtn = `<button class="select-room-btn ${isSelected ? 'selected-btn' : ''}" onclick="selectRoom('${roomId}')">
...
function updateBookingSummary() {
    ...
    document.getElementById('roomPricePerNight').textContent = formatCurrency(roomPrice);
