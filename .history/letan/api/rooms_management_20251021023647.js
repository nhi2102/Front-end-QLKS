...
document.addEventListener('DOMContentLoaded', () => {
    // defensive event wiring: check elements exist before attaching listeners
...
function updateStats() {
    ...
    // update DOM safely (guarding against missing elements)
...
function showLoading(show) {
    ...
    // if hiding loading, remove any loading placeholder but avoid clobbering rendered content
    const existing = grid.querySelector('.loading');
