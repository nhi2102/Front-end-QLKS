...
async function saveCustomer() {
    ...
    const customerData = {
        ...
        trangthai: document.getElementById('editTrangthai')?.value || 'Hoạt động',
        matkhau: currentCustomer?.matkhau || currentCustomer?.Matkhau || "temporary_password" // Giữ mật khẩu cũ hoặc dùng tạm thời
    };
