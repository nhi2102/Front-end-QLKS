...
// Đặt dịch vụ cho khách (gọi stored procedure TAO_SUDUNGDV)
...
// Lấy lịch sử dịch vụ của booking
...
// Backward compatibility: expose on window for non-module pages
try {
    window.fetchCurrentGuests = fetchCurrentGuests;
    window.fetchAvailableServices = fetchAvailableServices;
    window.bookServiceForGuest = bookServiceForGuest;
