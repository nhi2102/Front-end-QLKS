...
async function fetchBookingFullInfo(bookingId) {
    try {
        ...
        return {
            id: datphong.madatphong,
            bookingDate: datphong.ngaydat,
            status: datphong.trangthai,
            paymentStatus: datphong.trangthaithanhtoan,
            customerName: datphong.tenkhachhang,
            customerPhone: datphong.sodienthoai,
            customerEmail: datphong.email,
            customerID: datphong.cccd,
            roomNumber: chitiet.sophong,
            roomType: loaiphong ? .tenloaiphong || "",
            checkinDate: chitiet.ngaynhanphong,
            checkoutDate: chitiet.ngaytraphong,
            tienPhong: chitiet.tienphong,
            tienDichVu: chitiet.tiendichvu,
            totalAmount: datphong.tongtien,
            notes: datphong.ghichu
        };
    } catch (error) {
