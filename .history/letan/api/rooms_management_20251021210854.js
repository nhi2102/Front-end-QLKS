...
function initializeEventListeners() {
    ...
    document.getElementById('updateStatusBtn') ? .addEventListener('click', updateRoomStatus);
}
...
function openRoomDetail(roomId) {
    ...
    document.getElementById('modalRoomType').textContent = selectedRoom.maloaiphongNavigation ? .tenloaiphong || 'N/A';
