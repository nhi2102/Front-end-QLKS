...
const CheckoutAPI = {
    ...
    async executeCheckout(maDatPhong, manv) {
        // Nếu backend dùng GET, gửi manv qua query string
        const url = manv 
            ? `${API_BASE_URL}/Datphongs/Checkout/${maDatPhong}?manv=${manv}`
            : `${API_BASE_URL}/Datphongs/Checkout/${maDatPhong}`;
