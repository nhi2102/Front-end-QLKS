...
document.addEventListener("DOMContentLoaded", async function() {
    try {
        const res = await fetch("https://localhost:7076/api/LoaiPhongs/getfullloaiphong");
        ...
        topRooms.forEach(room => {
            ...
            card.innerHTML = `
                <div class="room-image">
                    <img src="../../assets/img/${room.hinhAnhUrl || 'room1_main.jpg'}" alt="${room.tenloaiphong}">
                    <div class="room-price">${room.giacoban.toLocaleString()} VNĐ/đêm</div>
                </div>
                <div class="room-content">
                    ...
                    <a href="../khachhang/rooms.html" class="button-secondary">Đặt phòng ngay</a>
                </div>
            `;
        ...
        btnPrev.addEventListener("click", () => {
            ...
            modalImg.src = `../../assets/img/${currentImages[currentIndex]}`;
        });
            ...
            if (e.target.classList.contains("room-title")) {
                ...
                try {
                    ...
                    if (currentImages.length === 0) {
                        alert("Phòng này chưa có ảnh chi tiết!");
                        return;
                    }
