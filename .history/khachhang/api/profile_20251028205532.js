...
window.addEventListener('DOMContentLoaded', () => {
    ...
    try {
        ...
        // Xử lý ngày sinh - chuyển đổi từ format server về format input date
        if (user.ngaysinh) {
            // Nếu ngày sinh có dạng "2023-12-31T00:00:00" thì lấy phần ngày
            const ngaysinhFormatted = user.ngaysinh.split('T')[0];
        ...
        profileForm.addEventListener('submit', async(e) => {
            ...
            try {
                ...
                const updateDto = {
                    ...
                    Sdt: sdt,
                    Cccd: cccd,
                    Ngaysinh: ngaysinh || user.ngaysinh || null,
                ...
                if (response.ok) {
                    ...
                    user.ngaysinh = updateDto.Ngaysinh;
