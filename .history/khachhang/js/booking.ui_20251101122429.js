...
async function handleFormSubmit(e) {
    ...
    try {
        ...
        // **ĐẢM BẢO LẤY ĐÚNG 499000**
        console.log('🔍 DEBUG SỐ TIỀN:');
        console.log('- result.tongTien:', result.tongTien, typeof result.tongTien);
        console.log('- Mong muốn: 499000');
        
        let finalAmount = result.tongTien;
        ...
        console.log('💰 Số tiền cuối cùng gửi VNPay:', finalAmount);
        console.log('✅ Khớp với mong muốn?', finalAmount === 499000);
