    ...
    try {
        ...
        if (result.hoaDonId) {
            try {
                ...
                console.log('🔍 KIỂM TRA PARSE SỐ:');
                console.log('- Raw value type:', typeof rawAmount, 'value:', rawAmount);
                console.log('- parseFloat(rawAmount):', parseFloat(rawAmount));
                console.log('- Math.round result:', finalAmount);
                console.log('- So sánh với 799:', finalAmount === 799);
