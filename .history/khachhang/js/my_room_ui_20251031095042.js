...
document.addEventListener('DOMContentLoaded', async function() {
            ...
            async function getTongTienFromHoaDon(hoaDonId) {
                ...
                try {
                    ...
                    const tongTien = hoaDon.tongTien || hoaDon.TongTien || hoaDon.tongtien || 0;
                    
                    console.log(`✅ Hóa đơn ${hoaDonId} - Tổng tiền: ${tongTien.toLocaleString('vi-VN')} VNĐ`);
                    return tongTien;
            ...
            async function createBookingCard(booking, isUpcoming) {
                ...
                // **LẤY TỔNG TIỀN TỪ HÓA ĐƠN (ƯU TIÊN CAO NHẤT)**
                // Đây là tổng tiền cuối cùng đã bao gồm tất cả (phòng + dịch vụ + giảm giá + điểm)
                const tongTienHoaDon = booking.tongtienhoadon || booking.TongTienHoaDon || 
                                     booking.tongTienCuoiCung || booking.TongTienCuoiCung ||
                                     booking.hoadonTongTien || booking.HoaDonTongTien || 0;
                ...
                console.log('   - HOADON.TONGTIEN:', tongTienHoaDon);
