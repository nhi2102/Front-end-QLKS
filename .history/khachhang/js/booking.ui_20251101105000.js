    ...
    try {
        ...
        if (result.hoaDonId) {
            try {
                ...
                // LẤY NGUYÊN XI TỔNG TIỀN HÓA ĐƠN (KHÔNG TÍNH TOÁN GÌ)
                finalAmount = hoaDonData.tongtien || hoaDonData.TongTien || 0;
                
                console.log('💰 Raw từ hóa đơn:', finalAmount, typeof finalAmount);
                console.log('💰 Truyền VNPay:', formatPrice(finalAmount));
