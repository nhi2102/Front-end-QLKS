    ...
    if (policyModal) {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                // Kiểm tra xem loadServices function có tồn tại không
                console.log('window.loadServices:', window.loadServices);
                console.log('typeof loadServices:', typeof loadServices);
                
                if (typeof window.loadServices === 'function') {
                    console.log('Gọi window.loadServices()');
                    window.loadServices();
                } else if (typeof loadServices === 'function') {
                    console.log('Gọi loadServices()');
                    loadServices();
                } else {
                    console.error('loadServices function không tồn tại!');
                }
