...
async function handleFormSubmit(e) {
    ...
    try {
        ...
        // **TÍNH TIỀN PHÒNG ĐỂ TRUYỀN VÀO VNPAY (không bao gồm dịch vụ)**
        ...
        // Áp dụng giảm giá đoàn (chỉ cho tiền phòng)
        ...
        // Áp dụng giảm giá điểm tích lũy (chỉ trên tiền phòng)
        const pointsDiscount = bookingData.diemSuDung || 0;
        const finalAmount = Math.max(0, finalRoomPrice - pointsDiscount);
        
        console.log('💰 Tiền phòng gốc:', formatPrice(roomPrice));
        console.log('💰 Giảm giá đoàn:', formatPrice(roomDiscount));
        console.log('💰 Giảm điểm tích lũy:', formatPrice(pointsDiscount));
        console.log('💰 Số tiền truyền VNPay (chỉ tiền phòng):', formatPrice(finalAmount));
