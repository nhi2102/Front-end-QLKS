            ...
            <div class="booking-card" data-booking-id="${madatphong}">
                ...
                <div class="card-footer">
                    <div class="footer-total-breakdown">
                        ...
                        ${booking.diemDaSuDung && booking.diemDaSuDung > 0 ? `
                        <div class="breakdown-item discount-info">
                            <span class="breakdown-label"><i class="fas fa-star"></i> Giảm giá từ điểm tích lũy:</span>
                            <span class="breakdown-value" style="color: #28a745;">-${formatCurrency(booking.diemDaSuDung)} (${booking.diemDaSuDung.toLocaleString('vi-VN')} điểm)</span>
                        </div>
                        ` : ''}
                    </div>
