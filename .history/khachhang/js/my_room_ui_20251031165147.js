...
document.addEventListener('DOMContentLoaded', async function() {
            ...
            async function createBookingCard(booking, isUpcoming) {
                ...
                chiTiet.forEach((ct, index) => {
                            ...
                            // DEBUG: Kiểm tra dữ liệu tính toán cho từng phòng
                            console.log(`🔍 DEBUG GIÁ PHÒNG - ${tenPhong} (ID: ${ct.idphong}):`);
                            console.log('- tongCong:', formatCurrency(tongCong));
                            console.log('- tongTienDichVu:', formatCurrency(tongTienDichVu));
                            console.log('- nights:', nights);
                            console.log('- phongInfo.giaphong:', phongInfo.giaphong);
                            console.log('- loaiphongInfo.giacoban:', loaiphongInfo.giacoban);
                            ...
                            console.log('💰 Kết quả: giaPhong =', formatCurrency(giaPhong), '/ tienPhong =', formatCurrency(tienPhong));
