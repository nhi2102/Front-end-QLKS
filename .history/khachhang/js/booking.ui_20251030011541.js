...
function displayRoomDetails(data) {
    ...
    // ✅ Lưu tổng tiền (bao gồm dịch vụ) để backend nhận được
    data.totalPrice = totalPrice;
    localStorage.setItem('currentBooking', JSON.stringify(data));  // 👈 THÊM DÒNG NÀY
}
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (continueBtn) {
        ...
        console.warn('Không tìm thấy nút #continuePayment khi khởi tạo!');
    }
});