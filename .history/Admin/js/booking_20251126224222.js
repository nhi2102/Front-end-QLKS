            ...
            function renderInvoices(invoices) {
                ...
                <td>
                    <span class="status-badge status-${inv.paymentStatus}">
                        ...
                        inv.paymentStatus === 'refunded' ? 'Đã xử lý' : 
                        'Chưa thanh toán'}
                    </span>
                </td>
                <td class="text-center">
            ...
            document.addEventListener('click', async e => {
                        ...
                        if (btn.dataset.action === 'view-booking') {
                            try {
                                ...
                                const finalTotal = (invoice && invoice.tongtien !== undefined) ? invoice.tongtien : (booking.totalAmount || 0);
        ...
        : ''
                                ...
                                <p><strong>Trạng thái thanh toán:</strong> 
                                    <span class="status-badge status-${invoice.paymentStatus}">
                                        ...
                                        invoice.paymentStatus === 'refunded' ? 'Đã xử lý' : 
                                        'Chưa thanh toán'}
                                    </span>
                                </p>
                            </div>
