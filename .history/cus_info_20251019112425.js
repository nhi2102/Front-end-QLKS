        ...
        if (result.success) {
            ...
            if (paymentMethod === 'vnpay') {
                ...
                try {
                    ...
                    // Sử dụng RETURN_BASE_URL từ window hoặc fallback về location.origin
                    const returnBaseUrl = window.RETURN_BASE_URL || window.location.origin;
                    ...
                    console.log(' Gọi createVNPayPayment với params:', {
                        ...
                        returnUrl: `${returnBaseUrl}/payment-result.html`
                    });
